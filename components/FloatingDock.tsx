...
import { Youtube, FileText, CheckSquare, MessageCircle, Trophy, Gamepad2, History, Gift, ShoppingBag, Calendar, Settings, ChevronLeft, Home, Menu, X, Bot, Book, Compass } from 'lucide-react';
...
export const FloatingDock: React.FC<Props> = ({ onTabSelect, onGoHome, onGoBack, isStudent, settings }) => {
    ...
    const menuItems: { id: StudentTab, icon: any, label: string, color: string }[] = [
        ...
        { id: 'EXPLORE', icon: Compass, label: 'Explorer', color: 'text-indigo-600' },
