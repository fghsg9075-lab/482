...
export const StudentDashboard: React.FC<Props> = ({ user, dailyStudySeconds, onSubjectSelect, onRedeemSuccess, settings, onStartWeeklyTest, activeTab, onTabChange, setFullScreen, onNavigate, isImpersonating, onNavigateToChapter, isDarkMode, onToggleDarkMode }) => {
  ...
  const renderExplorerTab = () => {
      return (
          <div className="bg-slate-50 pt-4 pb-32 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-y-auto max-h-[calc(100vh-4rem)]">
  ...
  const renderHeroLayer = () => {
    ...
    return (
      <div ref={heroRef} className="flex-1 flex flex-col items-center justify-start pt-6 pb-2 relative">
  ...
  const renderMainContent = () => {
      ...
      // EXPLORE TAB (LAYER 2)
      if (activeTab === 'EXPLORE' as any) return renderExplorerTab();
